...
bookConfig.loadingBackground="#222222";
bookConfig.logoHeight="40";
bookConfig.logoPadding="0";
bookConfig.logoTop="0";
bookConfig.appLogoOpenWindow="Blank";
bookConfig.toolbarColor="#222222";
...
bookConfig.LinkDownColor="#5CC0F2";
bookConfig.LinkAlpha="0.2";
bookConfig.OpenWindow="Blank";
bookConfig.showLinkHint="No";

bookConfig.macBookVersion = "ANfRumFLdcihKFYXggFLSfovKJXWkvEGeYupCPfVpuOPXUniOFbavoGCeRqgMJXVouKEdUrtMERfitDJTamrJGC687e753_";
bookConfig.UIBaseURL="mobile/";
bookConfig.isFlipPdf=false;
bookConfig.searchTextJS="mobile/javascript/search_config.js";
bookConfig.totalPageCount=17;
bookConfig.largePageWidth=1536;
bookConfig.largePageHeight=2048;
bookConfig.bookTitle="Cognizant Styleguide";
